                ...
                <div class="relative sm:max-w-sm w-full">
                    ...
                    <div class="relative w-full rounded-3xl  px-6 py-4 bg-gray-100 shadow-md">
                        ...
                        <form method="#" action="#" class="mt-10">
                            ...
                            <div class="mt-7">
                                <button class="bg-orange-500 w-full py-3 rounded-xl text-white shadow-xl hover:shadow-inner focus:outline-none transition duration-500 ease-in-out  transform hover:-translate-x hover:scale-105">
                                    Login
                                </button>
                            </div>
                            ...
                            <div class="flex mt-7 justify-center w-full">
                             ...
                             <div class="mt-7">
                                <div class="flex justify-center items-center">
                                    <label class="mr-2" >You are new?</label>
